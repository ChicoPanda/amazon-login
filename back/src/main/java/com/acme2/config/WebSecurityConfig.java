...
import com.acme2.security.auth.AuthenticationFailureHandler;
import com.acme2.security.auth.AuthenticationSuccessHandler;
import com.acme2.security.auth.LogoutSuccess;
import com.acme2.security.auth.RestAuthenticationEntryPoint;
import com.acme2.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.csrf().ignoringAntMatchers("/api/login", "/api/signup")
        ...
        .logoutSuccessHandler(logoutSuccess).deleteCookies(tokenCookie);
